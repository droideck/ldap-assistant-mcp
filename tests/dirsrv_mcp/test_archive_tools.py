...
class TestDnHandling:
    ...
    def test_dn_matches_section_case_insensitive(self):
        ...
        from ldap_assistant_mcp.dirsrv_mcp.tools.archive import _dn_matches_section
    ...
    def test_find_child_dns_proper(self):
        ...
        from ldap_assistant_mcp.dirsrv_mcp.tools.dse_utils import find_child_dns, normalize_dn
